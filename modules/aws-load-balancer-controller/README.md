...
| <a name="input_oidc"></a> [oidc](#input\_oidc) | HTTPS URL from OIDC provider to EKS Cluster | `string` | n/a | yes |
| <a name="input_project-name"></a> [project-name](#input\_project-name) | Project name to be used to name the resources (Name tag) | `string` | n/a | yes |
